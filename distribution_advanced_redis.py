...
#D Return the range
#Example: if prefix='abc' -> result: ('abb{', 'abc{') # the func will return the two strings, one just the caractère before the prefix and second the caractère after the prefix.
#END
